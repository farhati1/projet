    ...
    public partial class UserControlClient : UserControl
    {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ID != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Êtes vous sûre de vouloir supprimer ce client?", "Supprimer un client", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void tabPageSearchClient_Enter_1(object sender, EventArgs e)
        {
            db.DisplayAndSearch("SELECT * FROM Client_Table", dataGridViewClient);
        }

        private void tabPageSearchClient_Leave_1(object sender, EventArgs e)
        {
            textBoxSearchPhoneNo.Clear();
        }
    }
