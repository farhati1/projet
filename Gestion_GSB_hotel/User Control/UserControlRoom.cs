    ...
    public partial class UserControlRoom : UserControl
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (radioButtonNo.Checked)
                Free = "No";
            bool check;
            if (comboBoxType.SelectedIndex == -1 || textBoxPhoneNo.Text.Trim() == String.Empty || textBoxPhoneNo.Text.Trim() == String.Empty || Free == "")
        ...
        private void buttonDeleteRoom_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Êtes vous sûre de vouloir supprimer cette chambre?", "Supprimer chambre", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void buttonDeleteRoom_Click_1(object sender, EventArgs e)
        {
            if (Free == "Yes")
                radioButtonYes1.Checked = true;
            if (Free == "No")
